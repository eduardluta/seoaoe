...
const mockEmailData = {
  ...
  results: [
    ...
    },
    {
      ...
      mentioned: false,
      rawResponse: {
        text: "The best AI chatbots in 2024 include ChatGPT, Claude, and other major platforms. These tools offer advanced conversational AI, contextual understanding, and integration capabilities for businesses and individuals.",
      },
    },
    {
      provider: "deepseek",
...
export async function GET() {
  const html = generateEmailHTML(mockEmailData);
